...
public class CourseService {
    ...
    public List<CourseOutDTO> getAllCourses(){
        ...
        List<CourseOutDTO> courseDTOS = new ArrayList<>();

        for(Course course : courses){
            CourseOutDTO courseDTO = new CourseOutDTO(course.getName(), course.getDescription(), course.getPrice(), course.getDuration());
    ...
    public List<CourseOutDTO> filterCourses(Double minPrice, Double maxPrice, Integer minDuration, Integer maxDuration) {
        ...
        return courses.stream().map(course -> new CourseOutDTO(
                course.getName(),
